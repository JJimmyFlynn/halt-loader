...
/**
 * This autoloader will load and activate all plugins within folders in the
 * mu-plugins directory. The folder structure must be consistent
 * with typical plugin struecure (i.e. folder->index.php)
 */
...
class HaltLoader {
  ...
  private function checkCache() {
    $cache = get_site_option('halt_autoloader');
    if ($cache === false) {
      $this->updateCache();
      return;
    }
  ...
  private function updateCache() {
    ...
    update_site_option('halt_autoloader', self::$cache);
  }
